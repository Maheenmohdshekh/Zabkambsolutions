          ...
          {services.map((service, index) => (
            ...
            >
              <div className="flex items-start space-x-4">
                <div className={`w-12 h-12 ${service.color} rounded-xl flex items-center justify-center text-white text-xl transition-transform duration-300 group-hover:scale-110`}>
                  {service.icon}
                </div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center lg:text-right">
              <div className="text-6xl mb-4 hover:scale-110 transition-transform duration-500">🇮🇳</div>
